...
// @ts-ignore
import { createCommandFromDiscriminatorValue, serializeCommand, serializeUpdateCommandDto, type Command, type UpdateCommandDto } from '../../models/index.js';
// @ts-ignore
...
export interface CommandsItemRequestBuilder extends BaseRequestBuilder<CommandsItemRequestBuilder> {
     ...
     * @returns {RequestInformation}
     */
     toPutRequestInformation(body: UpdateCommandDto, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
...
export const CommandsItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    put: {
        ...
        requestBodySerializer: serializeUpdateCommandDto,
