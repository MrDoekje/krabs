 ...
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {QueuedTaskDto}
 */
// @ts-ignore
export function createQueuedTaskDtoFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoQueuedTaskDto;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
...
/**
 * The deserialization information for the current model
 * @param QueuedTaskDto The instance to deserialize into.
 * @returns {Record<string, (node: ParseNode) => void>}
 */
// @ts-ignore
export function deserializeIntoQueuedTaskDto(queuedTaskDto: Partial<QueuedTaskDto> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "createdAt": n => { queuedTaskDto.createdAt = n.getDateValue(); },
        "description": n => { queuedTaskDto.description = n.getStringValue(); },
        "id": n => { queuedTaskDto.id = n.getStringValue(); },
        "name": n => { queuedTaskDto.name = n.getStringValue(); },
        "queued": n => { queuedTaskDto.queued = n.getBooleanValue(); },
        "results": n => { queuedTaskDto.results = n.getCollectionOfObjectValues<TaskResult>(createTaskResultFromDiscriminatorValue); },
        "taskCommands": n => { queuedTaskDto.taskCommands = n.getCollectionOfObjectValues<TaskCommand>(createTaskCommandFromDiscriminatorValue); },
        "taskResultId": n => { queuedTaskDto.taskResultId = n.getGuidValue(); },
        "updatedAt": n => { queuedTaskDto.updatedAt = n.getDateValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export interface QueuedTaskDto extends AdditionalDataHolder, Parsable {
    /**
 ...
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param QueuedTaskDto The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeQueuedTaskDto(writer: SerializationWriter, queuedTaskDto: Partial<QueuedTaskDto> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!queuedTaskDto || isSerializingDerivedType) { return; }
    writer.writeDateValue("createdAt", queuedTaskDto.createdAt);
    writer.writeStringValue("description", queuedTaskDto.description);
    writer.writeStringValue("id", queuedTaskDto.id);
    writer.writeStringValue("name", queuedTaskDto.name);
    writer.writeBooleanValue("queued", queuedTaskDto.queued);
    writer.writeCollectionOfObjectValues<TaskResult>("results", queuedTaskDto.results, serializeTaskResult);
    writer.writeCollectionOfObjectValues<TaskCommand>("taskCommands", queuedTaskDto.taskCommands, serializeTaskCommand);
    writer.writeGuidValue("taskResultId", queuedTaskDto.taskResultId);
    writer.writeDateValue("updatedAt", queuedTaskDto.updatedAt);
    writer.writeAdditionalData(queuedTaskDto.additionalData);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
